...
- Continuation note:
  ...
  - The strongest env-backed proof is now [summary.json](/Users/user/PycharmProjects/xstocks-strategy-lab/tmp/proof/enso-portfolio-2026-04-03T22-33-23.502Z/summary.json), which reaches `quote_portfolio` and records the exact current blocker: upstream Enso bundle `500` on the promoted basket, plus explicit `AUSD` Ethereum/USDC metadata blockers.
