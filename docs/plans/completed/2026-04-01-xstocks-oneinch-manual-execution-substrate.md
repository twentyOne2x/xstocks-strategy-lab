...
3. Exported the new adapter from [index.ts](/Users/user/PycharmProjects/xstocks-strategy-lab/packages/xstocks/src/index.ts).
...
3. [server.js](/Users/user/PycharmProjects/xstocks-strategy-lab/apps/api/src/server.js) now wires an authenticated 1inch client when `ONEINCH_API_KEY` is present.
4. [contracts.js](/Users/user/PycharmProjects/xstocks-strategy-lab/apps/api/src/contracts.js) now documents `executionRouteId` on the execution write surface.
